                    ...
                    <div class="flex h-16 items-center justify-between">
                        ...
                        <div class="hidden sm:flex sm:items-center sm:ms-6">
                            <div class="ml-4 flex items-center md:ml-6 gap-3">
                                ...
                                <a :href="route('offer.offerNotifications')"
                                    ...
                                    <div v-if="$page.props.auth.notifications.length > 0" class="absolute inline-flex items-center justify-center w-6 h-6 text-xs font-bold text-white bg-red-500 border-2 border-white rounded-full -top-2 -end-2 dark:border-gray-900">
