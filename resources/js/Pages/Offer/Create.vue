        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div>
                    ...
                    <div v-if="offer_exist === true">
                        <div class="p-6 mt-4 bg-white overflow-hidden shadow-sm sm:rounded-lg">
                            <p>Вы уже предложили свою услугу</p>
                        </div>
                    </div>
                    <div v-else class="mt-4 bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <div class="p-6 text-gray-900 flex flex-col gap-4">
