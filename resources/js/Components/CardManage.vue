...
<template>
    ...
    <div class="w-full p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700">
        ...
        <div class="flex items-end justify-between">
            ...
            <div>
                <a :href="`/jobs/edit/${ job.id }`" class="inline-flex items-center px-4 py-2 bg-gray-800 border border-transparent rounded-md font-normal text-md text-white hover:bg-gray-700 focus:bg-gray-700 active:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150 ms-4">
                    Изменить
                ...
                <button id="deleteButton" @click="showModal(job.id)" class="inline-flex items-center px-4 py-2 bg-red-600 border border-transparent rounded-md font-normal text-md text-white hover:bg-red-700 focus:bg-red-600 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150 ms-4">
                    Удалить
                    <svg aria-hidden="true" class="text-white ms-2 w-6 h-6" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
        ...
        <div id="deleteModal" ref="modalEl" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-modal md:h-full">
            <div class="relative p-4 w-full max-w-md h-full md:h-auto">
                ...
                <div class="relative p-4 text-center bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                    ...
                    <form @submit.prevent="submit(job.id)" class="flex justify-center items-center space-x-4">
